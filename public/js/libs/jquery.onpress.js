    ...
    if ($.os.touch) {
        ...
        $.fn.onpress = function() {
            ...
            var handleTouchStart = function(e) {
                e.stopPropagation();
                var coords = e.originalEvent.touches ? e.originalEvent.touches[0] : e; // Android weirdness fix
            ...
            var handleTouchMove = function(e) {
                if (Math.abs(e.originalEvent.touches[0].pageX - touches[0]) > 10 || Math.abs(e.originalEvent.touches[0].pageY - touches[1]) > 10) {
                    resetHandlers();
                }
            };
